...
%   PLOTS = hEVMPlots(EVMINFO,EQSYM,REFSYM)
...
%                        (2 x Number of Slots)
%
%   PLOTS = hEVMPlots(...,EMISSIONS) EMISSIONS is an optional structure
%                        containing in-band emission statistics as defined
%                        in TS 38.101-1 (FR1) / TS 38.101-2 (FR2), Annex
...
% Copyright 2020-2021 The MathWorks, Inc.
    ...
    evmGridFigure.CurrentAxes.Title.String = {'EVM resource grid'}; 
    ...
    if nargin == 4 && ~isempty(emissions.DeltaRB)
        ...
        emissionsFigure.CurrentAxes.Title.String = {'Absolute in-band emissions' 'for each unallocated RB'};
